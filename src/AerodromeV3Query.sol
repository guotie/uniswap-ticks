...
contract AerodromeV3Query {
        ...
        )
    {
        ...
        {
            (sqrtPriceX96, tickCur, , , , ) = IUniswapV3PoolState(poolAddr)
                .slot0();
        ...
        {
            uint256 bitmap;
            int16 lWordNum = -int16((words >> 16) & uint(0xffff));
            int16 rWordNum = int16(words & uint(0xffff));
